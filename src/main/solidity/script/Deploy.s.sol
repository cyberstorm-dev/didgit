...
/**
 * @title Deploy
 * @dev Deployment script for UsernameUniqueResolver implementation and proxy upgrade
 */
contract Deploy is Script {
    function run() external {
        ...
        console.log("Deploying UsernameUniqueResolver implementation with deployer:", deployer);
        ...
        UsernameUniqueResolver newImplementation = new UsernameUniqueResolver(easAddress, schemaUid);
